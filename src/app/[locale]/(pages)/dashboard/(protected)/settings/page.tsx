      ...
      <Tabs defaultValue="appearance">
        ...
        <TabsContent value="appearance">
          <Card>
            <CardHeader>
              <CardTitle>
                {t("Dashboard.Settings.theme-and-appearance")}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {t(
                        "Dashboard.Settings.used-for-buttons-highlights-and-main-actions"
                      )}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {t(
                        "Dashboard.Settings.used-for-text-backgrounds-and-secondary-elements"
                      )}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {t(
                      "Dashboard.Settings.controls-the-roundness-of-buttons-inputs-and-cards"
                    )}
                  </p>
                </div>
              </div>
        ...
        <TabsContent value="payment">
          <Card>
            <CardHeader>
              <CardTitle>
                {t("Dashboard.Settings.payment-configuration")}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Stripe API Keys */}
