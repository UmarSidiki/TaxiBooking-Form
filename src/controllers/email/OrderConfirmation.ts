...
function generateEmailHTML(bookingData: BookingData, primaryColor: string, borderRadius: string) {
  const getCurrencySymbol = () => '€'; // Can be made dynamic later
  
  // SVG Icons as inline data - kept concise and inline for reliability
  const icons = {
    // Note: Converted original icons to be strictly inline-compatible (all sizing/color must be on the SVG itself)
    checkCircle: `<svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="#ffffff" stroke-width="2"/><path d="M8 12.5L10.5 15L16 9" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    ...
    car: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 13l1.5-4.5h11L19 13m-14 0v6h2v-2h10v2h2v-6M7 16h2m6 0h2" stroke="#111827" stroke-width="2" stroke-linecap="round"/></svg>`,
      ...
      <tr>
        <td align="center" style="padding: 0 20px;">
          <table width="600" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-radius: ${borderRadius}; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05); overflow: hidden;">
            ...
            <tr>
              <td align="center" style="background: linear-gradient(145deg, ${primaryColor} 0%, ${primaryColor}dd 100%); padding: 40px 30px; border-radius: ${borderRadius} ${borderRadius} 0 0;">
            ...
            <tr>
              <td style="padding: 32px 32px 24px 32px;">
                ...
                <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                  Thank you for choosing our service! Your trip has been confirmed. Please review your booking details below. We look forward to providing you with a comfortable journey.
                </p>
              </td>
            </tr>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                            <td colspan="2" style="padding-bottom: 16px;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td style="vertical-align: middle;">${icons.car}</td>
                                        <td style="color: #111827; font-size: 17px; font-weight: 600; padding-left: 8px;">Your Journey Snapshot</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                          ...
                          <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6;">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                ...
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; padding-left: 8px;">From</td>
                        ...
                        <tr>
                          <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6;">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td style="vertical-align: middle; width: 20px;">${icons.mapPin}</td>
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; padding-left: 8px;">To</td>
            ...
            <tr>
              <td style="padding: 0 32px 24px 32px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #f9fafb; border-radius: ${borderRadius}; border: 1px solid #e5e7eb;">
                  <tr>
                    <td style="padding: 20px 24px;">
                      <h3 style="margin: 0 0 16px 0; color: #111827; font-size: 17px; font-weight: 600;">Vehicle & Capacity</h3>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                          <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6;">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; vertical-align: middle;">Vehicle Chosen</td>
                        ...
                        <tr>
                          <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6;">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; vertical-align: middle;">Max. Seats</td>
                          ...
                          <td style="padding: 10px 0; ${bookingData.childSeats > 0 || bookingData.babySeats > 0 ? 'border-bottom: 1px solid #f3f4f6;' : ''}">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                ...
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; padding-left: 8px;">Adult Passengers</td>
                          ...
                          <td style="padding: 10px 0; ${bookingData.babySeats > 0 ? 'border-bottom: 1px solid #f3f4f6;' : ''}">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                ...
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; padding-left: 8px;">Child Seats (Group 1/2/3)</td>
                        ...
                        <tr>
                          <td style="padding: 10px 0;">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td style="vertical-align: middle; width: 20px;">${icons.baby}</td>
                                <td style="color: #6b7280; font-size: 14px; font-weight: 500; padding-left: 8px;">Baby Seats (Infant)</td>
            ...
            <tr>
              <td style="padding: 0 32px 32px 32px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color: ${primaryColor}15; border-radius: ${borderRadius}; border: 1px solid ${primaryColor}50;">
                  <tr>
                          ...
                          <td style="vertical-align: middle;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    ...
                                    <td style="color: #111827; font-size: 20px; font-weight: 700; padding-left: 10px; line-height: 1;">Total Amount</td>
                                </tr>
                            </table>
                          </td>
                          <td style="text-align: right; vertical-align: middle;">
                            <span style="color: ${primaryColor}; font-size: 34px; font-weight: 700; letter-spacing: -0.5px; line-height: 1;">${getCurrencySymbol()}${bookingData.totalAmount.toFixed(2)}</span>
                          </td>
                        </tr>
                    ...
                    <td style="padding: 24px;">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                          ...
                          <td style="padding-left: 12px;">
                            <h3 style="margin: 0 0 8px 0; color: #1e40af; font-size: 17px; font-weight: 600;">Need to contact us?</h3>
                            <p style="margin: 0; color: #1e3a8a; font-size: 14px; line-height: 1.6;">
                              If you have any questions or need to make changes to your booking, please don't hesitate to contact us. We're here to help make your journey smooth and comfortable!
                            </p>
                          </td>
                        </tr>
                      </table>
...
// The exported function remains the same, leveraging the enhanced generateEmailHTML
export async function sendOrderConfirmationEmail(bookingData: BookingData) {
  try {
    ...
    // Ensure default colors are robust for the refactored template
    const primaryColor = settings?.primaryColor || '#10B981'; // Switched default to a clean green/teal for variety, or keep as EAB308
    const borderRadiusNum = settings?.borderRadius || 0.5;
    const borderRadius = `${Math.round(borderRadiusNum * 16)}px`; // Convert rem to px and round for clean pixel value
