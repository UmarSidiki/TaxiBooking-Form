...
export const cashBookingBaseSchema = z.object({
...
/** A destination booking needs a dropoff or at least one stop. */
export function requireDropoffOrStop(
  data: {
...
export const cashBookingInputSchema =
  cashBookingBaseSchema.superRefine(requireDropoffOrStop);
